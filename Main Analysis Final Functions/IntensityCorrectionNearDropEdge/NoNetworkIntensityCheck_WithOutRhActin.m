...
%%% The goal of this part in to correct the intensity decrees near the drop
...
slide_folder=[main_folder,'2018_01_01\Intensity near drop edge\Slide 16_25 z stack\'];

BackNoFluLA=1182; %%% this number is for exposure time of 100ms
...
Capture1=importdata([main_folder,'2018_01_01\Intensity near drop edge\Slide 1 15_45 z stack\Capture.mat']);
Capture2=importdata([main_folder,'2018_01_01\Intensity near drop edge\Slide 1 17_10 z stack\Capture.mat']);
Capture3=importdata([main_folder,'2018_01_01\Intensity near drop edge\Slide 16_25 z stack\Capture.mat']);
NamesCapture=[Capture1,Capture2,Capture3];
...
%     label=TypeOfLabelsCorrNearEdge(t).name;
    label=TypeOfLabelsCorrNearEdge(1).name;
