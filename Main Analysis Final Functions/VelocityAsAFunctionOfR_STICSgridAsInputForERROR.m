%%%% Modified at 21.8 for returning R_sort and Vr_sort for error calculation 

function [R_sort,Vr_sort]= VelocityAsAFunctionOfR_STICSgridAsInputForERROR(Capture_folder,ROI_folder);
