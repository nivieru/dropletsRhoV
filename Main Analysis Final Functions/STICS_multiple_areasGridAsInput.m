function ROI_folder=STICS_multiple_areasGridAsInput(Capture_folder,EdgeLimit)
...
ROI_folder=[Capture_folder,'Velocity\STICS\ROI[',int2str(roi(1)),' ',int2str(roi(2)),' ',int2str(roi(3)),' ',int2str(roi(4)),']','DCC',int2str(interrogationarea),'_',int2str(step),'\'];
mkdir(ROI_folder)
