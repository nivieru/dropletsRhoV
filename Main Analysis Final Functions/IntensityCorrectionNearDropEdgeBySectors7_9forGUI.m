...
function IntensityCorrectionNearDropEdgeBySectors7_9forGUI(Capture_folder,AverageProfileX,AverageProfileY,ImageToAnalyze)
...
save([Capture_folder,'Rho\OriginalAvgRrho.mat'],'OriginalAvgRrho');
save([Capture_folder,'Rho\OriginalAvgRho.mat'],'OriginalAvgRho');
save([Capture_folder,'Rho\OriginalAvgRhoDownSTD.mat'],'OriginalAvgRhoDownSTD');
save([Capture_folder,'Rho\OriginalAvgRhoUpSTD.mat'],'OriginalAvgRhoUpSTD');
