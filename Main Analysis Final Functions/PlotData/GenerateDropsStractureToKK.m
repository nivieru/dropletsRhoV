...
function DROPS=GenerateDropsStractureToKK(directory,filename,DropsForPlot);
...
Col(59,:)=[195/255 105/255 165/255]; 
...
Col(203,:)=[195/255 105/255 165/255]; %%% magemta
