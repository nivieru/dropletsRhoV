...
for j=Jinitial:NoOfConditions
    ...
    hold on
    plot(AverageValues(j).meanRrho,AverageValues(j).meanRho,'Color',DROPS(i).Color,'LineWidth',1)
%     hold on
...
if (NoOfConditions>1)
    j=1;
    hold on
    plot(AverageValues(j).meanRrho,AverageValues(j).meanRho,'Color',[128/255 128/255 128/255],'LineWidth',1)
end
...
for j=Jinitial:NoOfConditions
    ...
    for i=placeDrops(1):placeDrops(end)
        h(i)=plot(DROPS(i).RnormByRdrop,DROPS(i).RhoNorm,'LineWidth',0.5,'Color',DROPS(i).Color);
        hold on
    end
    
    hold on
    plot(AverageValues(j).meanRrho2,AverageValues(j).meanRho2,'Color',DROPS(i).Color,'LineWidth',1)
%     hold on
...
if (NoOfConditions>1)
    j=1;
    hold on
    plot(AverageValues(j).meanRrho2,AverageValues(j).meanRho2,'Color',[128/255 128/255 128/255],'LineWidth',1)
end
...
savefig([save_to_file,'rho vs r_Rdrop.fig']);
saveas(figure (5),[save_to_file,'rho vs r_Rdrop.tif']);
...
for j=Jinitial:NoOfConditions
    ...
    hold on
    plot(AverageValues(j).MeanRhoForDivJ,AverageValues(j).MeanDivJ,'Color',DROPS(i).Color,'LineWidth',1)
    hold on
...
if (NoOfConditions>1)
    ...
    j=1;
    hold on
    plot(AverageValues(j).MeanRhoForDivJ,AverageValues(j).MeanDivJ,'Color',[128/255 128/255 128/255],'LineWidth',1)
%     hold on
...
for j=Jinitial:NoOfConditions
    ...
    for i=placeDrops(1):placeDrops(end)
        h(i)=plot(DROPS(i).RnormForDivJ,DROPS(i).ForceBalanceEq,'LineWidth',0.5,'Color',DROPS(i).Color);
        hold on
    end
    
    hold on
    plot(AverageValues(j).MeanR_ForForceBalanceEq,AverageValues(j).MeanForceBalanceEqVsR,'Color',DROPS(i).Color,'LineWidth',1)
%     hold on
%     plot(AverageValues(j).MeanR_ForDivJ,AverageValues(j).lowerLineMeanDivJvsR,'Color','k','LineWidth',0.5)
%     hold on
%     plot(AverageValues(j).MeanR_ForDivJ,AverageValues(j).upperLineMeanDivJvsR,'Color','k','LineWidth',0.5)
...
if (NoOfConditions>1)
    j=1;
    hold on
    plot(AverageValues(j).MeanR_ForForceBalanceEq,AverageValues(j).MeanForceBalanceEqVsR,'Color',[128/255 128/255 128/255],'LineWidth',1)
end
...
saveas(figure (6),[save_to_file,'Div V vs r.tif']);
saveas(figure (6),[save_to_file,'Div V vs r'],'epsc');



%% Div rho as a function of Rho
...
saveas(figure (7),[save_to_file,'Div V vs rho.tif']);
