...
function DROPS=GenerateDropsStractureToKKforVforGUI_Niv(XLSfilename,expTypeInd,Col)
    DROPS=GenerateDropsStractureToKKforGUICommon_Niv(XLSfilename,expTypeInd,Col)
